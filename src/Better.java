...
public class Better {
   ...
   public static void main(String[] args) {
      int n = fr.readInt();
      String[] die1 = fr.readLine().split(" ");
      String[] die2 = fr.readLine().split(" ");
      solve(n, die1, die2);
      pw.flush();
      pw.close();
   }

   public static void solve(int n, String[] die1, String[] die2) {
      double d1 = 0;
      double d2 = 0;
      for (int i = 0; i < n; i++) {
         d1 += Integer.parseInt(die1[i]);
         d2 += Integer.parseInt(die2[i]);
      }
      if (d1 == d2 && d1 % n == d1 % n) {
         pw.println("tie");
      } else if ((d1 % n == d2 % n) && (d1 > d2)) {
         pw.println("second");
      } else {
         pw.println("first");
      }
