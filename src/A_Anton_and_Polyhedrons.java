...
public class A_Anton_and_Polyhedrons {
   ...
   public static void solve(String[] fig, int n) {
      int ans = 0;
      for (int i = 0; i < n; i++) {
         if (fig[i].equals("Tetrahedron")) {
            ans += 4;
         } else if (fig[i].equals("Cube")) {
            ans += 6;
         } else if (fig[i].equals("Octahedron")) {
            ans += 8;
         } else if (fig[i].equals("Dodecahedron")) {
            ans += 12;
         } else {
            ans += 20;
         }
